...
function ajouter(id2) {
  ...
  if (countarr == 0) {
    // si il n'ya pas de pion sur la case d'arrive je déplace normalement mon pion
    switch (pion) {
      case "cava":
    ...
    if (
      document.getElementById(id2).firstChild.className !=
